...
import leftcircle from '../../assets/left_circle.svg'
const SeventhPage = () => {
  return (
    <div
    className="seventh-section"
    style={{
      backgroundImage: `url(${leftcircle}), linear-gradient(#351953, #351953)`,
  ...
  >
     {/* <img src={leftcircle} className="background-svg" alt="Left Circle" /> */}
  ...
  <img src={champ} width={48} height={48} style={{marginTop:'20px'}}/>  <h2>  Certified  <br/>& Accredited Courses</h2></div>  
            ...
            <div style={{display:"flex"}}>  <img src={seventhimage2} width={48} height={48} style={{marginTop:'20px'}}/>
          ...
          <div style={{display:"flex"}}>  <img src={seventhimage3} width={48} height={48} style={{marginTop:'20px'}}/>
          <h2>30+ Years  <br />
          of Expertise </h2></div>
            ...
            quality, and efficiency.
                      ...
                      <div style={{display:"flex"}}>  <img src={seventhimage4} width={48} height={48} style={{marginTop:'20px'}}/>
            ...
            <div style={{display:"flex"}}>  <img src={seventhimage5} width={48} height={48} style={{marginTop:'20px'}}/>
